...
@Composable
fun CartScreenPembeli(viewModel: AuthViewModel?, navController: NavHostController) {
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        navController.navigate(Routes.ROUTE_HOME_PEMBELI.route) {
                            popUpTo(Routes.ROUTE_HOME_PEMBELI.route) { inclusive = true }
                        }
                    }
            )
            Text(
