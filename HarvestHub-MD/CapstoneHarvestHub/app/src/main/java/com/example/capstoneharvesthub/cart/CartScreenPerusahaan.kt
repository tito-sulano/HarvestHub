...
@Composable
fun CartScreenPerusahaan(viewModel: AuthViewModel?, navController: NavHostController) {
    ...
    Scaffold(topBar = {
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        navController.navigate(Routes.ROUTE_HOME_PERUSAHAAN.route) {
                            popUpTo(Routes.ROUTE_HOME_PERUSAHAAN.route) { inclusive = true }
                        }
                    }
            )
            Text(
        ...
        Box {
            Column(
                ...
                Text(text = "Cart Screen Perusahaan")
            }
        }
    })
