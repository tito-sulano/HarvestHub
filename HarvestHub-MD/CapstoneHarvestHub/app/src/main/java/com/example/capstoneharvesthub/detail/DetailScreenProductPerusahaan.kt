...
@Composable
fun DetailScreenProductPerusahaan(viewModel: AuthViewModel, navController: NavHostController, productId: String?) {
    ...
    LaunchedEffect(key1 = productId) {
        if (productId != null) {
            if (userID != null) {
                viewModel.getDataProductPerusahaanId(userID, productId, context) { productDetail ->
                    productDetail.id
                }
            }
        }
            ...
            Scaffold(topBar = {
                TopAppBar(
                    ...
                    Icon(
                        ...
                        modifier = Modifier
                            .padding(16.dp)
                            .clickable { navController.navigate(Routes.ROUTE_HOME_PERUSAHAAN.route) },
                    )
                    Text(
